...
<body>
    <header>
        <div class ="container">
            ...
            <div class="body-tag">
                    <form action="renew.p.php" method="post" class="starlabel my-4 mx-4" onsubmit="return confirmSubmit()">

                    <div class="form-group">
                            <label for="username" style="color:green;">Enter Passport Number</label>
                            <input type="text" class="form-control" id="username" name="username" value = "<?php $_SESSION['username']?>">
                        </div>
