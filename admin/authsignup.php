...
<body>
    <header>
        ...
        <strong>Success!</strong> Authority account is now created'. '
        ...
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">×</span>
                ...
                <div class="container my+4">
                    <h1 class="text-center" style="color:green;">Signup<br>New Authority</h1>
                    <form action="authsignup.php" method="post" class="starlabel">
