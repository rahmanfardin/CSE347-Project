...
<body>
    <header>
        <div class ="container">
            ...
            <div class="body-tag">
            <h1 class="text-center" style="color:green;">Passport Revoke Application <br> </h1>
                    <form action="r.a.php" method="post" class="starlabel my-4 mx-4" onsubmit="return confirmSubmit()">
